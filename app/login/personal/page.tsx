      ...
      <div className="w-full max-w-md">
        ...
        <Card className="bg-gray-800 border-gray-700">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl text-white">Personal Learning</CardTitle>
            <p className="text-gray-400">Your personal learning journey</p>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-400">
                New to learning?{" "}
                <Link href="/join" className="text-red-400 hover:text-red-300">
                  Start your journey
                </Link>
              </p>
            </div>
